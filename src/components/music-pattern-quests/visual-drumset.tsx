...
interface VisualDrumsetProps {
    beatTitle: string;
}

const drumMap: { [key: string]: 'bass' | 'snare' | 'hihat' } = {
  'F': 'bass',
  'c': 'snare',
  'g': 'hihat',
};
...
const beats: { [key: string]: { notes: string[], duration: number }[] } = {
    'the basic rock beat': [
        { notes: ['F'], duration: 600 },
        { notes: ['c'], duration: 600 },
        { notes: ['F'], duration: 600 },
        { notes: ['c'], duration: 600 },
        { notes: ['F'], duration: 600 },
        { notes: ['c'], duration: 600 },
    ...
    'adding the hi hats': [
        { notes: ['g', 'F'], duration: 300 },
        { notes: ['g'], duration: 300 },
        { notes: ['g', 'c'], duration: 300 },
        { notes: ['g'], duration: 300 },
        { notes: ['g', 'F'], duration: 300 },
        { notes: ['g'], duration: 300 },
        { notes: ['g', 'c'], duration: 300 },
...
export function VisualDrumset({ beatTitle }: VisualDrumsetProps) {
    const [isPlaying, setIsPlaying] = useState(false);
    const [activeDrumParts, setActiveDrumParts] = useState(new Set<string>());
    const timeoutsRef = useRef<NodeJS.Timeout[]>([]);
    
    const kickAudioRef = useRef<HTMLAudioElement>(null);
    const snareAudioRef = useRef<HTMLAudioElement>(null);
    const hihatAudioRef = useRef<HTMLAudioElement>(null);

    const currentBeat = beats[beatTitle] || beats['the basic rock beat'];
    ...
    useEffect(() => {
      ...
      const playDrumSound = (drumPart: string) => {
        if (drumPart === 'bass' && kickAudioRef.current) {
            kickAudioRef.current.currentTime = 0;
            kickAudioRef.current.play();
        } else if (drumPart === 'snare' && snareAudioRef.current) {
            snareAudioRef.current.currentTime = 0;
            snareAudioRef.current.play();
        } else if (drumPart === 'hihat' && hihatAudioRef.current) {
            hihatAudioRef.current.currentTime = 0;
            hihatAudioRef.current.play();
        }
      }
    ...
    const playBeat = () => {
        ...
        currentBeat.forEach((step, index) => {
            const timeout = setTimeout(() => {
                const newActiveParts = new Set<string>();
                step.notes.forEach(note => {
                    const drumPart = drumMap[note];
                    if (drumPart) {
                        newActiveParts.add(drumPart);
                        playDrumSound(drumPart);
                    }
                });
                setActiveDrumParts(newActiveParts);
                
                const offTimeout = setTimeout(() => {
                    setActiveDrumParts(new Set());
                }, 200); // Highlight duration
                timeoutsRef.current.push(offTimeout);

                if (index === currentBeat.length - 1) {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center gap-4">
        <audio ref={kickAudioRef} src="https://raw.githubusercontent.com/ArunMichaelDsouza/javascript-30-course/master/src/01-javascript-drum-kit/sounds/kick.wav" preload="auto"></audio>
        <audio ref={snareAudioRef} src="https://raw.githubusercontent.com/ArunMichaelDsouza/javascript-30-course/master/src/01-javascript-drum-kit/sounds/snare.wav" preload="auto"></audio>
        <audio ref={hihatAudioRef} src="https://raw.githubusercontent.com/ArunMichaelDsouza/javascript-30-course/master/src/01-javascript-drum-kit/sounds/hihat-close.wav" preload="auto"></audio>
        <div className="relative flex items-center justify-center p-4 bg-card rounded-lg h-[600px] overflow-hidden">
            <style jsx>{`
                #Kick.active > #Kick-Drum > circle:first-of-type {
                    fill: #dc2626;
                }
                #Snare-Drum.active > rect:first-of-type {
                    fill: #dc2626;
                }
                #Hi-Hat.active > #Hi-Hat-Top > path,
                #Hi-Hat.active > #Hi-Hat-Bottom > path {
                  fill: #dc2626;
                }
            `}</style>
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="300 300 1400 1400" className="w-full h-full">
            <g id="Drums">
                <g>
                    ...
                    <g id="Snare">
                        <g id="Snare-Drum" className={cn(activeDrumParts.has('snare') ? 'active' : '')}>
                            
                                <rect x="1219" y="885" fill="#E5E7EB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="223" height="110"/>
                            <line fill="none" stroke="#9CA3AF" strokeWidth="8" strokeMiterlimit="10" x1="1438" y1="914" x2="1223" y2="914"/>
                            <g>
                                
                                    <path fill="#F9FAFB" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" d="
                                ...
                                <g>
                                        ...
                                        <line fill="none" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="1293" y1="971" x2="1293" y2="958"/>
                                    
                                        <line fill="none" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="1293" y1="922" x2="1293" y2="909"/>
                                ...
                                <g>
                                        ...
                                        <line fill="none" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="1368" y1="971" x2="1368" y2="958"/>
                                    
                                        <line fill="none" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="1368" y1="922" x2="1368" y2="909"/>
                                ...
                                <rect x="1209" y="885" fill="#F9FAFB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="241" height="21"/>
                            
                                <rect x="1209" y="974" fill="#F9FAFB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="241" height="21"/>
                            <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="1213" y1="900" x2="1446" y2="900"/>
                            <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="1213" y1="989" x2="1446" y2="989"/>
                        </g>
                        <g id="Snare-Stand">
                            
                                <rect x="1321" y="1087" fill="#F9FAFB" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="17" height="95"/>
                            <g>
                                <g>
                                        ...
                                        <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="1395.4" y1="1252.8" x2="1328.2" y2="1185.6"/>
                                    
                                        <path fill="#4B5563" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" d="
                                ...
                                <g>
                                        ...
                                        <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="1265.7" y1="1252.8" x2="1330.5" y2="1187.9"/>
                            ...
                            <g>
                                <g>
                                    <g>
                                        ...
                                        <path fill="#D1D5DB" d="M1203.8,1006.6l118.8,13.3l0.2-2l-121.6-13.6C1201.6,1005.5,1202.6,1006.4,1203.8,1006.6z"/>
                                    </g>
                                    <g>
                                        
                                            <path fill="#F9FAFB" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" d="
                                            M1462,992h-13v5.3l-114.7,12.8l1.6,12.9l120.5-13.5c3.6-0.4,5.5-4,5.5-7.5l0,0V992z"/>
                                        <path fill="#D1D5DB" d="M1338.5,1017.7l0.2,2l117.8-13.1c1.1-0.1,1.9-0.9,2.5-1.9L1338.5,1017.7z"/>
                                ...
                                <g>
                                    <g>
                                            ...
                                            <rect x="1323.6" y="1017" transform="matrix(1 5.709041e-03 -5.709041e-03 1 6.0417 -7.5767)" fill="#F9FAFB" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="13" height="75"/>
                                        
                                            <circle fill="#F9FAFB" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" cx="1330.6" cy="1016.8" r="8.5"/>
                                    ...
                                    <g>
                                        ...
                                        <line fill="none" stroke="#D1D5DB" strokeWidth="2" strokeMiterlimit="10" x1="1408.9" y1="1017" x2="1344.2" y2="1081"/>
                                        
                                            <circle fill="#F9FAFB" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" cx="1414.6" cy="1007.8" r="8.5"/>
                                    ...
                                    <g>
                                        ...
                                        <line fill="none" stroke="#D1D5DB" strokeWidth="2" strokeMiterlimit="10" x1="1247.8" y1="1011" x2="1317.1" y2="1081"/>
                                        
                                            <circle fill="#F9FAFB" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" cx="1248.6" cy="1007.8" r="8.5"/>
                    ...
                    <g id="Floor-Tom">
                        <g id="Floor-Tom-Drum">
                                ...
                                <rect x="541" y="878" fill="#E5E7EB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="287" height="320"/>
                            <line fill="none" stroke="#9CA3AF" strokeWidth="8" strokeMiterlimit="10" x1="824" y1="907" x2="545" y2="907"/>
                            <g>
                                <g>
                                    ...
                                    <g>
                                            ...
                                            <line fill="none" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="637" y1="912" x2="637" y2="899"/>
                                    ...
                                    <g>
                                            ...
                                            <line fill="none" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="732" y1="912" x2="732" y2="899"/>
                                    ...
                                    <rect x="532" y="878" fill="#F9FAFB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="304" height="21"/>
                                <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="536" y1="893" x2="832" y2="893"/>
                            </g>
                            <g>
                                <g>
                                    ...
                                    <g>
                                            ...
                                            <line fill="none" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="732" y1="1164" x2="732" y2="1177"/>
                                    ...
                                    <g>
                                            ...
                                            <line fill="none" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="637" y1="1164" x2="637" y2="1177"/>
                                    ...
                                    <rect x="533" y="1177" fill="#F9FAFB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="304" height="21"/>
                                <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="537" y1="1192" x2="833" y2="1192"/>
                            </g>
                        </g>
                        <g id="Floor-Tom-Legs">
                            <g>
                    ...
                    <g id="Hi-Hat" className={cn(activeDrumParts.has('hihat') ? 'active' : '')}>
                        <g id="Hi-Hat-Stand-Top">
                                ...
                                />
                            <rect x="1483" y="800" fill="#D1D5DB" width="11" height="78"/>
                            
                                <path fill="#4B5563" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" d="
                                M1502.7,775c0-1-0.7-0.6-0.7-0.7v-0.5c0-4.6-3-7.8-7.6-7.8h-10.5c-4.6,0-8.9,3.2-8.9,7.8v0.5c0,0.1,0.7-0.3,0.7,0.7H1502.7z"/>
                            <g id="Hi-Hat-Top">
                                
                                    <path fill="#E5E7EB" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" d="
                                    ...
                                    <line fill="none" stroke="#F3F4F6" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="1479" y1="783" x2="1497" y2="783"/>
                            </g>
                        </g>
                        <g id="Hi-Hat-Bottom">
                                ...
                                <line opacity="0.3" fill="none" stroke="#9CA3AF" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="1479" y1="826" x2="1497" y2="826"/>
                        </g>
                        <g id="Hi-Hat-Stand">
                            
                                <rect x="1480" y="833" fill="#F9FAFB" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="17" height="367"/>
                            <g>
                                <g>
                                        ...
                                        <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="1553.9" y1="1268.8" x2="1486.7" y2="1201.6"/>
                                ...
                                <g>
                                    ...
                                    <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="1424.2" y1="1268.8" x2="1489" y2="1203.9"/>
                            ...
                            <g>
                                    ...
                                    <circle fill="#F9FAFB" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" cx="1504.7" cy="998.5" r="10"/>
                    ...
                    <g id="Main-Kit">
                        <g id="Toms">
                            ...
                            <g id="Tom-Left-All">
                                <g id="Tom-Left-Drum">
                                        ...
                                        <rect x="750" y="679" fill="#E5E7EB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="221" height="184"/>
                                    <line fill="none" stroke="#9CA3AF" strokeWidth="8" strokeMiterlimit="10" x1="754" y1="708" x2="967" y2="708"/>
                                    <g>
                                        <g>
                                            
                                                <path fill="#F8FDFD" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" d="
                                            ...
                                            <g>
                                                    ...
                                                    <line fill="#F8FDFD" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="823" y1="711" x2="823" y2="698"/>
                                            ...
                                            <g>
                                                    ...
                                                    <line fill="#F8FDFD" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="897" y1="711" x2="897" y2="698"/>
                                            ...
                                            <rect x="741" y="679" fill="#F8FDFD" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="238" height="21"/>
                                        <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="975" y1="694" x2="745" y2="694"/>
                                    </g>
                                    <g>
                                        <g>
                                            ...
                                            <g>
                                                    ...
                                                    <line fill="#F9FAFB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="897" y1="831" x2="897" y2="844"/>
                                            ...
                                            <g>
                                                    ...
                                                    <line fill="#F9FAFB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="823" y1="831" x2="823" y2="844"/>
                                            ...
                                            <rect x="741" y="842" fill="#F8FDFD" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="238" height="21"/>
                                        <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="975" y1="858" x2="745" y2="858"/>
                                    </g>
                                </g>
                                <g>
                                        ...
                                        V782.1z"/>
                                    <path fill="#D1D5DB" d="M955.6,786h-18.9c1.4,2.4,3.9,4,6.9,4h5.1C951.7,790,954.3,788.4,955.6,786z"/>
                                        ...
                                        "/>
                                    <path fill="#D1D5DB" d="M1015.4,774h-67.8c1.1,2.4,3.6,4,6.5,4h54.4c0,0,0.1,0,0.1,0C1011.8,778,1014.3,776.4,1015.4,774z"/>
                                    
                                        <circle fill="#F9FAFB" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" cx="1009.1" cy="770.8" r="13.3"/>
                            ...
                            <g id="Tom-Right-All">
                                <g id="Tom-Right-Drum">
                                        ...
                                        <rect x="1101" y="679" fill="#E5E7EB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="221" height="184"/>
                                    <line fill="none" stroke="#9CA3AF" strokeWidth="8" strokeMiterlimit="10" x1="1105" y1="708" x2="1318" y2="708"/>
                                    <g>
                                        <g>
                                            ...
                                            <g>
                                                    ...
                                                    <line fill="#F8FDFD" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="1174" y1="711" x2="1174" y2="698"/>
                                            ...
                                            <g>
                                                    ...
                                                    <line fill="#F8FDFD" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="1248" y1="711" x2="1248" y2="698"/>
                                            ...
                                            <rect x="1092" y="679" fill="#F8FDFD" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="238" height="21"/>
                                        <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="1326" y1="694" x2="1096" y2="694"/>
                                    </g>
                                    <g>
                                        <g>
                                            ...
                                            <g>
                                                    ...
                                                    <line fill="#F9FAFB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="1248" y1="831" x2="1248" y2="844"/>
                                            ...
                                            <g>
                                                    ...
                                                    <line fill="#F9FAFB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="1174" y1="831" x2="1174" y2="844"/>
                                            ...
                                            <rect x="1092" y="842" fill="#F8FDFD" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="238" height="21"/>
                                        <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="1326" y1="858" x2="1096" y2="858"/>
                                    </g>
                                </g>
                                <g>
                                        ...
                                        V759.9z"/>
                                    <path fill="#D1D5DB" d="M1116.5,786h18.9c-1.4,2.4-3.9,4-6.9,4h-5.1C1120.5,790,1117.9,788.4,1116.5,786z"/>
                                    ...
                                    <path fill="#D1D5DB" d="M1056.7,774h67.8c-1.1,2.4-3.6,4-6.5,4h-54.4c0,0,0.1,0,0.1,0C1060.3,778,1057.9,776.4,1056.7,774z"/>
                                    
                                        <circle fill="#F9FAFB" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" cx="1063" cy="770.8" r="13.3"/>
                        ...
                        <g id="Kick" className={cn(activeDrumParts.has('bass') ? 'active' : '')}>
                            <g id="Kick-Stand">
                                <g>
                            ...
                            <g id="Kick-Drum">
                                    ...
                                    <circle fill="#E5E7EB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" cx="1035.7" cy="1085" r="210"/>
                                <circle id="Inner-Drum-Wobble" fill="none" cx="1035.7" cy="1085" r="201.2"/>
                                
                                    <circle id="Inner-Drum" fill="#F9FAFB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" cx="1035.7" cy="1085" r="192.6"/>
                                <g>
                                    <g>
                                        <g>
                                            
                                                <path fill="#F9FAFB" stroke="#333333" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" d="
                                        ...
                                        <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="835" y1="1101" x2="835" y2="1069"/>
                                    </g>
                                    <g>
                                        <g>
                                        ...
                                        <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="949.7" y1="1266.2" x2="922" y2="1250.2"/>
                                    </g>
                                    <g>
                                        <g>
                                            ...
                                            <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="1149.6" y1="1250.2" x2="1121.8" y2="1266.2"/>
                                    </g>
                                    <g>
                                        <g>
                                        ...
                                        <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="1235" y1="1069" x2="1235" y2="1101"/>
                                    </g>
                                    <g>
                                        <g>
                                        ...
                                        <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="1122" y1="903.8" x2="1149.7" y2="919.8"/>
                                    </g>
                                    <g>
                                        <g>
                                        ...
                                        <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="921.8" y1="919.8" x2="949.6" y2="903.8"/>
                                    </g>
                                </g>
                            </g>
                        </g>
                    ...
                    <g id="Crash">
                        <g id="Crash-Stand-Top">
                            ...
                            <g id="Crash-Cymbol">
                                    ...
                                    <line fill="none" stroke="#F3F4F6" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" x1="572.3" y1="630.1" x2="546.6" y2="620.8"/>
                            </g>
                        </g>
                        <g id="Crash-Stand">
                            
                                <rect x="493" y="787" fill="#F9FAFB" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" width="17" height="409"/>
                            <g>
                                <g>
                                    ...
                                    <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="566.9" y1="1265.8" x2="499.7" y2="1198.6"/>
                                ...
                                <g>
                                    ...
                                    <line fill="none" stroke="#D1D5DB" strokeWidth="4" strokeMiterlimit="10" x1="437.2" y1="1265.8" x2="502" y2="1200.9"/>
                                ...
                                <g>
                                    ...
                                    <path fill="#333333" d="M504.5,1192.5c-1.8-1.3-4.3-0.9-5.6,0.9c-1.3,1.8-0.9,4.3,0.9,5.6c1.8,1.3,4.3,0.9,5.6-0.9
                                        C506.7,1196.3,506.1,1193.8,504.5,1192.5z"/>
                                </g>
                            </g>
                            <g>
                                
                                    <circle fill="#F9FAFB" stroke="#333333" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" cx="517.7" cy="994.5" r="10"/>
        ...
        <div className="flex gap-4">
            <Button onClick={playBeat} disabled={isPlaying}>
                <Play className="mr-2"/>
                start
            </Button>
            <Button onClick={stopBeat} disabled={!isPlaying} variant="destructive">
